...
//        LogUtil.shieldPartialLog(LogUtil.VERBOSE);
//        LogUtil.saveToFile(SDCardUtils.getSDCardPath() + "MyDVR_Debug_Log.txt");
//        LogUtil.closeSaveToFile();   //关闭log输出到文件
//        LogUtil.closeLog();


        //TODO: 打开应用倒车，是否应该放到其他地方？
        CommonUtils.writeExitFlag(AppConfig.FILE_EXIT_HANDLE, 1);
