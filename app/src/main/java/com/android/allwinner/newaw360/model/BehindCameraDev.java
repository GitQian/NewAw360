...
//        }
    ...
    public File makeFile() {
        ...
        File file;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            file = new File(AppConfig.BEHIND_VIDEO_PATH + "Behind_" + DateTimeUtil.getCurrentDateTimeReplaceSpace() + mTimeStr + ".ts");
        } else {
            file = new File(AppConfig.BEHIND_VIDEO_PATH + "Behind_" + DateTimeUtil.getCurrentDateTimeReplaceSpace() + mTimeStr + ".mp4");
        }
        return file;
    }
    ...
    public String makeFilePath() {
        ...
        String path = null;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            path = AppConfig.BEHIND_VIDEO_PATH + "Behind_" + DateTimeUtil.getCurrentDateTimeReplaceSpace() + "_" + solution + mTimeStr + ".ts";
        } else {
            path = AppConfig.BEHIND_VIDEO_PATH + "Behind_" + DateTimeUtil.getCurrentDateTimeReplaceSpace() + "_" + solution + mTimeStr + ".mp4";
        }
        return path;
    }
    ...
    public void putVidingPath(String videoPath) {
        SPUtils.put(MyApplication.getContext(), "BehindVideoPath", videoPath);
    }
}
